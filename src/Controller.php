...
abstract class Controller extends AbstractController
{
	...
	{
		$this->response()->withAddedHeader( 'Access-Control-Allow-Origin', Config::getInstance()->getConf( 'access_control_allow_origin' ) );
		$this->response()->withAddedHeader( 'Content-Type', 'application/json; charset=utf-8' );
		$this->response()->withAddedHeader( 'Access-Control-Allow-Headers', Config::getInstance()->getConf( 'access_control_allow_headers' ) );
		$this->response()->withAddedHeader( 'Access-Control-Allow-Methods', Config::getInstance()->getConf( 'access_control_allow_methods' ) );
